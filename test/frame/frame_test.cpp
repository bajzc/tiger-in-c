...
TEST(frame, allocLocals) {
  ...
  // add locals manually
  EXPECT_EQ(F_isInReg(F_allocLocal(frame, true, 0)), false);
  EXPECT_EQ(F_isInReg(F_allocLocal(frame, false, 0)), true);
  EXPECT_EQ(F_isInReg(F_allocLocal(frame, true, 1)), false);
  EXPECT_EQ(F_isInReg(F_allocLocal(frame, true, 0)), false);
